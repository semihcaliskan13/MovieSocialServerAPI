...
{
    public class MovieListWriteRepository : WriteRepository<MovieSocialAPI.Domain.Entities.MovieList>, IMovieListsWriteRepository

    {
        public MovieListWriteRepository(MovieSocialAPIDbContext context) : base(context)
        {
        }
    }
}
