        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MovieTMDBId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedTime = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "MovieListMovieListMovie",
                columns: table => new
                {
                    MovieListMoviesId = table.Column<int>(type: "int", nullable: false),
                    MovieListsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieListMovieListMovie", x => new { x.MovieListMoviesId, x.MovieListsId });
                    table.ForeignKey(
                        name: "FK_MovieListMovieListMovie_MovieListMovies_MovieListMoviesId",
                        column: x => x.MovieListMoviesId,
                        principalTable: "MovieListMovies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieListMovieListMovie_MovieLists_MovieListsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Favorite_Quotes_QuoteId",
                        column: x => x.QuoteId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieListMovieListMovie_MovieListsId",
                table: "MovieListMovieListMovie",
                column: "MovieListsId");
